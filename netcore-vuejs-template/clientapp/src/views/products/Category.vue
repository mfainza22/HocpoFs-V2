  ...
  methods: {
    ...
    async create() {
      ...
      try {
        ...
        noti.type = "success";
        noti.content = "New category added successfully";
        this.close();
      } catch (error) {
        noti.type = "error";
    ...
    async update() {
      ...
      try {
        await categoryService.update(this.item.id, this.item);
        noti.type = "success";
        noti.content = "Category updated successfully";
        this.close();
      } catch (error) {
        noti.type = "error";
        noti.content = error;
    ...
    async getDetails() {
      try {
        const response = await categoryService.getById(this.id);
